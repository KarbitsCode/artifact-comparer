...
1. Downloading the previous/base artifact (via `dawidd6/action-download-artifact`)
...
- comparer logic runs inline via `actions/github-script` (no action-local npm install/runtime dependencies)
